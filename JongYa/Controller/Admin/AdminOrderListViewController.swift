//
//  AdminAdminOrderListViewController.swift
//  JongYa
//
...
class AdminOrderListViewController: MainTableViewController {
    ...
    override func reloadContent() {
        ...
        try! appDatabase.inDatabase { db in
            content = try InvoieDB.order(Column("date").desc).fetchAll(db) 
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
            ...
            cell.detailLabel?.text = "ยอดรวม : \(total)"
            return cell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let view = AppGlobal.storyboard.main.instantiateViewController(withIdentifier: "AdminOrderDetailListViewController") as! AdminOrderDetailListViewController
